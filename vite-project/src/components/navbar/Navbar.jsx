                  ...
                  <div className="flow-root">
                    <Link to={'/'} className="-m-2 block p-2 font-medium text-gray-900 cursor-pointer">
                      <img
                        ...
                        // src='F:\E-Commerce\vite-project\src\components\navbar\IMG-20231017-WA0000 (1).jpg'
                        alt="Ganesh_Pawar" />                                        </Link>
                  </div>
                </div>
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <Link to={'/'} className='flex'>
                  <div className="flex ">
                    <h1 className=' text-2xl font-bold text-black  px-2 py-1 rounded' style={{ color: mode === 'dark' ? 'white' : '', }}>DYP</h1>
                  </div>
                </Link>
              </div>
